# optiontech_web/settings/base.py
"""
Base settings for optiontech_web project.
"""
...
META_SITE_DOMAIN = config('META_SITE_DOMAIN', default='optiontech.id')
...
if EMAIL_BACKEND != 'django.core.mail.backends.console.EmailBackend':
    ...
    DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@optiontech.id')
