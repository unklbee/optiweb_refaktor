...
MIDDLEWARE = [
    ...
    'core.middleware.BusinessInfoMiddleware',
    'customers.middleware.CustomerProfileMiddleware',
]

ROOT_URLCONF = 'optiontech_web_v2.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.device_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'optiontech_web_v2.wsgi.application'
...
# Custom settings
SITE_NAME = 'Service Laptop Bandung'
...
SITE_AUTHOR = 'Service Laptop Bandung'